...
$$.OAuth2 = {"":
 ...
 set$_token: function(value) {
  var t1 = ({});
  t1.value_1 = value;
  var invokeCallbacks = $.eqNullB(this.__token) && !$.eqNullB(t1.value_1);
  try {
    this.set$_storedToken(t1.value_1);
  } catch (exception) {
 ...
 OAuth2$4: function(clientId, scopes, provider, tokenLoaded) {
  ...
  try {
    this.set$_token(this.get$_storedToken());
  } catch (exception) {
    $.unwrapException(exception);
  }
...
$$.Closure45 = {"":
 ...
 $call$1: function(json) {
  ...
  if (valid === true) {
    ...
    this.this_2.set$_email(t1);
    t1 = $.index(data, 'user_id');
    this.this_2.set$_userId(t1);
  }
  return valid;
 }
};
...
$.Token$3 = function(type, data, expiry) {
  return new $.Token((void 0), (void 0), expiry, data, type);
};
...
$.OAuth2$4 = function(clientId, scopes, provider, tokenLoaded) {
  var t1 = new $.OAuth2((void 0), (void 0), (void 0), (void 0), tokenLoaded, provider, scopes, clientId);
